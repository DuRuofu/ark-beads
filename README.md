...
一个用于《明日方舟》拼豆小游戏的离线桌面自动化工具。导入 24×24 模板、完成四点校准后，Ark Beads 会自动选择颜色并逐格绘制。
...
目前已在官方 macOS 客户端中完成实际绘制测试，并提供 Windows x64 测试版本。
...
3. 进入“校准界面”，依次采集画布左上格、右下格，以及色盘第一页左上、右下色块的中心。
